...
// MARK: - Updated GameSetupView Integration

/*


// And update the role selection flow:
...
// MARK: - Create Lottie Animation Files

/*
You'll need two Lottie animation JSON files:

1. "connection-animation.json" - For the waiting/connecting state
   - Download from: https://lottiefiles.com/search?q=loading&category=animations
   - Good options: spinning circles, connecting dots, wireless signal

2. "no-game-animation.json" - For the no game found state
   - Download from: https://lottiefiles.com/search?q=empty&category=animations
   - Good options: empty box, sad face, question mark

Add both JSON files to your Xcode project (just drag and drop into the project navigator)
*/
